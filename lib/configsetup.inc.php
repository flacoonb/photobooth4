...
return [
    'general' => [
        ...
        'dev_capture_async_legacy' => [
            'view' => 'expert',
            'type' => 'checkbox',
            'name' => 'dev[capture_async_legacy]',
            'value' => $config['dev']['capture_async_legacy'],
        ],
        'dev_capture_async_timeout_queued' => [
            'view' => 'expert',
            'type' => 'range',
            'placeholder' => $defaultConfig['dev']['capture_async_timeout_queued'],
            'name' => 'dev[capture_async_timeout_queued]',
            'value' => $config['dev']['capture_async_timeout_queued'],
            'range_min' => 5,
            'range_max' => 600,
            'range_step' => 1,
            'unit' => 'seconds',
        ],
        'dev_capture_async_timeout_running' => [
            'view' => 'expert',
            'type' => 'range',
            'placeholder' => $defaultConfig['dev']['capture_async_timeout_running'],
            'name' => 'dev[capture_async_timeout_running]',
            'value' => $config['dev']['capture_async_timeout_running'],
            'range_min' => 15,
            'range_max' => 1800,
            'range_step' => 1,
            'unit' => 'seconds',
